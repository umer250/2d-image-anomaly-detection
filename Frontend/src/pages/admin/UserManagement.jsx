...
import { Users, UserPlus, Search, Edit2, Trash2, Mail, Shield, AlertCircle, CheckCircle2 } from 'lucide-react';
                                ...
                                <tr>
                                    <td colSpan="4" className="px-6 py-20 text-center">
                                        <div className="flex flex-col items-center">
                                            ...
                                            <p className="text-zinc-600 text-xs mt-1">Try adjusting your search query</p>
                                        </div>
                                    </td>
                                </tr>
            ...
            <AnimatePresence>
                {toast && (
                    <motion.div
                        ...
                        className={`fixed bottom-8 right-8 z-[60] flex items-center p-4 rounded-2xl shadow-2xl border ${toast.type === 'error' ? 'bg-red-900 border-red-500 text-red-100' : 'bg-green-900 border-green-500 text-green-100'
                            }`}
                    >
